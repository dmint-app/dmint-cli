...
def main(args: list[str] | None = None) -> int:
    ...
    # Normalize subcommands like "create policy" -> "create-policy" and "compile policy" -> "compile-policy"
    ...
    subparsers.add_parser(
        "create-policy",
        help="Interactive wizard to discover tools, ask security questions, and create policy files",
        add_help=False,
    )
